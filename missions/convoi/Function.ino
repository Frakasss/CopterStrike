...
void fnctn_checkButtons() {
  ...
  //TODO PAUSE? if(gb.buttons.pressed(BTN_C)){gameStatus=SELECTMAP;}
  ...
  if (player.isLanding == 0 && player.life > 0) {
    ...
    if (player.hSpeed > 0) {
      for (i = 0; i < player.hSpeed; i++)      {
        if (player.x_world < LEVELWIDTH) {
          player.x_world++;
        }
      }
    } else if (player.hSpeed < 0) {
      for (i = 0; i < abs(player.hSpeed); i++) {
        if (player.x_world > 0) {
          player.x_world--;
        }
      }
    ...
    if (player.vSpeed > 0) {
      for (i = 0; i < player.vSpeed; i++)      {
        if (player.y_world < LEVELHEIGHT) {
          player.y_world++;
        }
      }
    } else if (player.vSpeed < 0) {
      for (i = 0; i < abs(player.vSpeed); i++) {
        if (player.y_world > 13) {
          player.y_world--;
        }
      }
    }
...
void fnctn_initLevel() {
  ...
  bkgrnd[12].x_world = 253;   bkgrnd[12].y_world = 159;   bkgrnd[12].width = 36;  bkgrnd[12].height = 24; bkgrnd[12].sprite = 8; //oasis
  bkgrnd[13].x_world = 152;   bkgrnd[13].y_world = 414;   bkgrnd[13].width = 36;  bkgrnd[13].height = 24; bkgrnd[13].sprite = 8;
  bkgrnd[14].x_world = 526;   bkgrnd[14].y_world = 284;   bkgrnd[14].width = 36;  bkgrnd[14].height = 24; bkgrnd[14].sprite = 8;
  ...
  building_friend[3].x_world = 221;     building_friend[3].y_world = 53; //camp
  building_friend[4].x_world = 288;     building_friend[4].y_world = 166;
  building_friend[5].x_world = 430;     building_friend[5].y_world = 223;
  building_friend[6].x_world = 306;     building_friend[6].y_world = 276;
  building_friend[7].x_world = 269;     building_friend[7].y_world = 355;
  building_friend[8].x_world = 166;     building_friend[8].y_world = 304;
  for (i = 0; i < 9; i++) {
    ...
    if (i < 3) { //village
      ...
      building_friend[i].sprite = 6;
      building_friend[i].life = 20;
    }
  }

  //building shooting / destructible
  building_hostile[0].x_world = 108;    building_hostile[0].y_world = 180; //tours
  building_hostile[1].x_world = 77;    building_hostile[1].y_world = 205;
  building_hostile[2].x_world = 294;   building_hostile[2].y_world = 105;
  building_hostile[3].x_world = 294;   building_hostile[3].y_world = 141;
  building_hostile[4].x_world = 441;   building_hostile[4].y_world = 126;
  building_hostile[5].x_world = 278;   building_hostile[5].y_world = 222;
  building_hostile[6].x_world = 242;   building_hostile[6].y_world = 249;
  building_hostile[7].x_world = 400;   building_hostile[7].y_world = 272;
  building_hostile[8].x_world = 439;   building_hostile[8].y_world = 276;
  building_hostile[9].x_world = 455;   building_hostile[9].y_world = 301;
  building_hostile[10].x_world = 416;  building_hostile[10].y_world = 334;
  building_hostile[11].x_world = 381;  building_hostile[11].y_world = 305;
  building_hostile[12].x_world = 95;  building_hostile[12].y_world = 286;
  building_hostile[13].x_world = 135;  building_hostile[13].y_world = 305;
  building_hostile[14].x_world = 117;  building_hostile[14].y_world = 344;
  building_hostile[15].x_world = 78;  building_hostile[15].y_world = 325;
  building_hostile[16].x_world = 169;  building_hostile[16].y_world = 351;
  building_hostile[17].x_world = 28;   building_hostile[17].y_world = 171; //bunker
  building_hostile[18].x_world = 401;  building_hostile[18].y_world = 36;
  building_hostile[19].x_world = 94;  building_hostile[19].y_world = 303;
  building_hostile[20].x_world = 405;  building_hostile[20].y_world = 289;
  for (i = 0; i < 21; i++) {
    ...
    if (i < 17) {
      ...
      building_hostile[i].sprite = 7;
      building_hostile[i].life = 20;
    } else {
      building_hostile[i].width = 32;
      building_hostile[i].height = 32;
      building_hostile[i].sprite = 5;
      building_hostile[i].life = 80;
    }
  }

  //mobile ennemies
  mobilUnit_hostile[0].x_world = 211;  mobilUnit_hostile[0].y_world = 49;   mobilUnit_hostile[0].batiment = 3; //infantry
  mobilUnit_hostile[1].x_world = 236;  mobilUnit_hostile[1].y_world = 13;   mobilUnit_hostile[1].batiment = 3;
  mobilUnit_hostile[2].x_world = 260;  mobilUnit_hostile[2].y_world = 107;   mobilUnit_hostile[2].batiment = 4;
  mobilUnit_hostile[3].x_world = 309;  mobilUnit_hostile[3].y_world = 166;   mobilUnit_hostile[3].batiment = 4;
  mobilUnit_hostile[4].x_world = 293;  mobilUnit_hostile[4].y_world = 191;   mobilUnit_hostile[4].batiment = 4;
  mobilUnit_hostile[5].x_world = 310;  mobilUnit_hostile[5].y_world = 264;   mobilUnit_hostile[5].batiment = 6;
  mobilUnit_hostile[6].x_world = 294;  mobilUnit_hostile[6].y_world = 276;   mobilUnit_hostile[6].batiment = 6;
  mobilUnit_hostile[7].x_world = 448;  mobilUnit_hostile[7].y_world = 225;   mobilUnit_hostile[7].batiment = 5;
  mobilUnit_hostile[8].x_world = 441;  mobilUnit_hostile[8].y_world = 246;   mobilUnit_hostile[8].batiment = 5;
  mobilUnit_hostile[9].x_world = 209;  mobilUnit_hostile[9].y_world = 298;   mobilUnit_hostile[9].batiment = 7;
  mobilUnit_hostile[10].x_world = 192; mobilUnit_hostile[10].y_world = 346;  mobilUnit_hostile[10].batiment = 7;
  mobilUnit_hostile[11].x_world = 203; mobilUnit_hostile[11].y_world = 358;  mobilUnit_hostile[11].batiment = 7;
  mobilUnit_hostile[12].x_world = 277; mobilUnit_hostile[12].y_world = 346;  mobilUnit_hostile[12].batiment = 8;
  mobilUnit_hostile[13].x_world = 286;  mobilUnit_hostile[13].y_world = 358;  mobilUnit_hostile[13].batiment = 8;
  mobilUnit_hostile[14].x_world = 92; mobilUnit_hostile[14].y_world = 585;  mobilUnit_hostile[14].batiment = 8;

  mobilUnit_hostile[15].x_world = 299; mobilUnit_hostile[15].y_world = 29;   mobilUnit_hostile[0].batiment = 18; //tank
  mobilUnit_hostile[16].x_world = 414;  mobilUnit_hostile[16].y_world = 276;  mobilUnit_hostile[0].batiment = 17;
  mobilUnit_hostile[17].x_world = 219; mobilUnit_hostile[17].y_world = 354;  mobilUnit_hostile[0].batiment = 19;
  mobilUnit_hostile[18].x_world = 170; mobilUnit_hostile[18].y_world = 366;  mobilUnit_hostile[0].batiment = 20;
  mobilUnit_hostile[19].x_world = 73; mobilUnit_hostile[19].y_world = 402;  mobilUnit_hostile[0].batiment = 20;
  for (i = 0; i < 20; i++) {

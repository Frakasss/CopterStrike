...
void fnctn_initLevel(){
  ...
  mobilUnit_hostile[2].x_world=586;  mobilUnit_hostile[2].y_world=275;   mobilUnit_hostile[2].batiment=4;
  mobilUnit_hostile[3].x_world=366;  mobilUnit_hostile[3].y_world=455;   mobilUnit_hostile[3].batiment=5;
  mobilUnit_hostile[4].x_world=617;  mobilUnit_hostile[4].y_world=520;   mobilUnit_hostile[4].batiment=6;
  mobilUnit_hostile[5].x_world=550;  mobilUnit_hostile[5].y_world=535;   mobilUnit_hostile[5].batiment=7;
  mobilUnit_hostile[6].x_world=519; mobilUnit_hostile[6].y_world=592;  mobilUnit_hostile[6].batiment=8;
  mobilUnit_hostile[7].x_world=93;  mobilUnit_hostile[7].y_world=586;  mobilUnit_hostile[7].batiment=2;
  mobilUnit_hostile[8].x_world=379; mobilUnit_hostile[8].y_world=23;   mobilUnit_hostile[8].batiment=18; //tank
  mobilUnit_hostile[9].x_world=73;  mobilUnit_hostile[9].y_world=284;  mobilUnit_hostile[9].batiment=17;
  mobilUnit_hostile[10].x_world=411; mobilUnit_hostile[10].y_world=398;  mobilUnit_hostile[10].batiment=19;
  mobilUnit_hostile[11].x_world=576; mobilUnit_hostile[11].y_world=531;  mobilUnit_hostile[11].batiment=20;
  for(i=0;i<NB_MOBILE_UNIT;i++){
      ...
      if(coordx>building_hostile[i].x_world && coordx<building_hostile[i].x_world+building_hostile[i].width && coordy>building_hostile[i].y_world && coordy<building_hostile[i].y_world+building_hostile[i].height){
        if(building_hostile[i].life>0){
          ...
          if(building_hostile[i].life==0 && building_hostile[i].animBoom==0){
            ...
            switch(building_hostile[i].sprite){
              case 7: money = money + 250; break;  //tour
              case 5: money = money + 1000; break; //bunker
            }
          }
        }
      }
        ...
        if(building_friend[i].life>0){
          ...
          if(building_friend[i].life==0 && building_friend[i].animBoom==0){
            switch(building_friend[i].sprite){
               ...
               case 6: money = money + 350; break; //camp
               case 8: money = money + 200; break; //village
            }
          }
        }
      }
